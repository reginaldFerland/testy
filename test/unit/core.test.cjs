...
test('generated-header classification uses the same byte prefix for saves and disk events',()=>{
 const {isGeneratedSource}=require('../../out/core/paths');
 for(const content of ['// <auto-generated/>','// '+ 'é'.repeat(1000)+' <auto-generated/>','// '+ 'é'.repeat(1100)+' <auto-generated/>']){
  const bytes=Buffer.from(content);
  assert.equal(isGeneratedSource('Code.CS',content),isGeneratedSource('Code.CS',bytes));
  assert.equal(isGeneratedSource('Code.CS',content),isGeneratedSource('Code.CS',bytes.subarray(0,2048).toString('utf8')));
 }
 assert.equal(isGeneratedSource('generator.data','<auto-generated/>'),false);
});
